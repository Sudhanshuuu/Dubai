...
const RealEstate = ({ createModal , query }) => {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md md:rounded-lg">
            <table className="w-[95%] md:w-[80vw]  text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 sm:ml-0">
                ...
                <tbody >
                    {data.map((data, index) => (
                        ...
                        >
                            ...
                            <td className=" flex flex-col py-2 md:px-0 md:py-2">
