...
import Content from "../../components/HolidayRealEstate/Content";
import Footer from "../../components/Footer";
import HeroSection from "../../components/HolidayRealEstate/HeroSection";

function HolidayRealEstate() {
    ...
    useEffect(() => {
        async function getData() {
            await axios.get(`${process.env.REACT_APP_API_URL}/realEstate?type=HolidayHome`)
                .then(response => {
...
export default HolidayRealEstate;