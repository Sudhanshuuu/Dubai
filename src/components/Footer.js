...
const Footer = () => {
  return (
    <footer className="bg-black text-center text-white *:font-sans">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="">
            ...
            <p>
              At UCS Prime, we understand that everyone has a unique vision for their ideal Dubai
              investments. That's why we offer a diverse range of properties to suit all types and budgets.
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              Reef Tower, Cluster O Floor 6 Office 601
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-black p-4 text-center text-white dark:bg-neutral-700 dark:text-neutral-200">
        © 2023 Copyright:
      </div>
    </footer>
  );
