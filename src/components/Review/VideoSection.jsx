...
function VideoSection() {
    return (<div className="*:font-sans">
        <div className="flex justify-evenly flex-wrap relative px-[5%]">
        
           <div className="m-[1%] mb-[2%] lg:w-[31%] relative">
                 <div className="bg-black absolute top-0 bottom-0 left-0 right-0 opacity-15"></div>
                 <img src={PlayButton} alt="Play" className="absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] w-20"/>
                <img src="https://images.pexels.com/photos/6140697/pexels-photo-6140697.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Carrer" className="h-[50vh] object-cover" />
            </div>
           <div className="m-[1%] mb-[2%] lg:w-[31%] relative">
                 <div className="bg-black absolute top-0 bottom-0 left-0 right-0 opacity-15"></div>
                 <img src={PlayButton} alt="Play" className="absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] w-20"/>
                <img src="https://plus.unsplash.com/premium_photo-1661573405291-7459db94d220?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Carrer" className="h-[50vh] object-cover" />
            </div>
           <div className="m-[1%] mb-[2%] lg:w-[31%] relative">
                 <div className="bg-black absolute top-0 bottom-0 left-0 right-0 opacity-15"></div>
                 <img src={PlayButton} alt="Play" className="absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] w-20"/>
                <img src="https://images.unsplash.com/photo-1456324504439-367cee3b3c32?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Carrer" className="h-[50vh] object-cover" />
            </div>
           <div className="m-[1%] mb-[2%] lg:w-[31%] relative">
                 <div className="bg-black absolute top-0 bottom-0 left-0 right-0 opacity-15"></div>
                 <img src={PlayButton} alt="Play" className="absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] w-20"/>
                <img src="https://images.unsplash.com/photo-1552960366-b330a2f83823?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Carrer" className="h-[50vh] object-cover" />
            </div>
           <div className="m-[1%] mb-[2%] lg:w-[31%] relative">
                 <div className="bg-black absolute top-0 bottom-0 left-0 right-0 opacity-15"></div>
                 <img src={PlayButton} alt="Play" className="absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] w-20"/>
...
const VideoSection = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center lg:flex-row">
            <section className="bg-white w-[80%] py-10 dark:bg-dark">
                <div ref={domNode} className="container">
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full px-4 lg:w-10/12">
                            <div className="relative z-20  h-[250px] overflow-hidden rounded-lg ">
