...
function HeroSection() {
    return (<div className="relative h-[85vh] w-screen">
        ...
        <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] *:text-white w-[100vw]">
            <div className="text-4xl md:text-8xl font-medium font-sans">About Real Estate Co.</div>
            <div className=" font-sans">Dubai’s fastest growing brokerage, while providing a new standard of service.</div>
