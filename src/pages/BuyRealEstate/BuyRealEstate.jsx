...
import HeroSection from "../../components/BuyRealEstate/HeroSection";
import Content from "../../components/BuyRealEstate/Content";
...
function BuyRealEstate() {
    ...
    useEffect(() => {
        async function getData() {
            await axios.get(`${process.env.REACT_APP_API_URL}/realEstate?type=Buy`)
                .then(response => {
