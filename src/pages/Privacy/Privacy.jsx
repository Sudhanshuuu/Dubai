...
function Privacy() {
    return (<div>
        <Navbar />
        <div className="justify-left text-left relative mt-[8%] z-10 overflow-hidden bg-gray-100 py-20 dark:bg-dark  px-[3%] mx-auto md:mt-[2%] *:font-sans">
            <h1 className="font-bold my-10 text-[32px] text-center">Privacy Policy</h1>
            <h1 className="font-semibold my-10">Our Values
            </h1>
            <p>Should we ask you to provide certain information by which you can be identified when using this
                website, then you can be assured that it will only be used in accordance with this privacy
                statement.
                UCS Prime real estate may change this policy from time to time by updating this page. You
                should check this page from time to time to ensure that you are happy with any changes. This
                policy is effective from May 31st, 2024.</p>

            <h1 className="font-semibold my-10">What we collect</h1>
            ...
            <h1 className="font-semibold my-10">What we do with the information we gather</h1>
            <p>We require this information to understand your needs and provide you with a better service, and
                ...
                customize the website according to your interests.</p>


            <h1 className="font-semibold my-10">Security</h1>
            ...
            <h1 className="font-semibold my-10">How we use cookies
            </h1>
            ...
            <h1 className="font-semibold my-10">Links to other websites</h1>
            <p>Our website may contain links to other websites of interest. However, once you have used these
                ...
                Some of these links may be affiliate links that allow me to operate this website </p>


            <h1 className="font-semibold my-10">Controlling your personal information</h1>
            <p>You may choose to restrict the collection or use of your personal information in the following
                ...
                purposes, you may change your mind at any time by contacting us.<br />
                ...
                may find interesting if you tell us that you wish this to happen.<br />
