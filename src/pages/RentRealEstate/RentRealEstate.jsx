...
import Content from "../../components/RentRealEstate/Content";
import Footer from "../../components/Footer";
import HeroSection from "../../components/RentRealEstate/Herosection";
...
function RentRealEstate() {
    ...
    useEffect(() => {
        async function getData() {
            await axios.get(`${process.env.REACT_APP_API_URL}/realEstate?type=Rent`)
                .then(response => {
