...
function List() {
    ...
    return (
        <>
            <section className="relative mt-[8%] z-10 overflow-hidden bg-gray-100 py-20 dark:bg-dark  px-[10%] mx-auto md:mt-[5%] *:font-sans">
                            ...
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <div className="mb-8 flex  w-full">
                                    ...
                                    <div className="w-full">
                                        <h4 className="mb-1 text-xl text-left font-bold text-dark dark:text-white">
                                            Unrivalled local knowledge
                                        </h4>
                                        <p className="text-base text-body-color text-left dark:text-dark-6">
                                            Our dedicated area specialists know the current market trends and can give you up-to-date advice.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color text-left dark:text-dark-6">
                                            Day or night, our property consultants work round the clock to ensure you get the best out of your investment!
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full">
                                    ...
                                    <div className="w-full">
                                        <h4 className="mb-1 text-xl text-left font-bold text-dark dark:text-white">
                                            160+ community experts
                                        </h4>
                                        <p className="text-base text-body-color text-left dark:text-dark-6">
                                            All our brokers bring a wealth of experience, knowledge and lead from the communities they serve.
                                        </p>
                                    </div>
                                </div>
                            </div>
